...
namespace VirtualPhenix.GridEngine
{
    ...
    public class VP_GridKeyboardDrivenController : MonoBehaviour
    {
        ...
        protected virtual void ExecuteInput(Vector2Int? direction = null)
        {
            ...
            var targetPosition = _gridObject.GridPosition + actionDirection;
        ...
        protected virtual void MovementEnded(VP_GridMovement movement, VP_GridTile fromGridPos, VP_GridTile toGridPos)
        {
            ExecuteQueuedInput();
        }
