...
// Modified SceneReference from JohannesMP (2018-08-12) for VP
//
...
// 
//     -   SceneAsset goes null on build, but sceneName is serialized
...
namespace VirtualPhenix
{
    ...
    /// </summary>
    [System.Serializable]
    public class VP_SceneReference : ISerializationCallbackReceiver
    {
        ...
        public string SerializedSceneName
        {
            get
            {
                return m_scene;
        ...
        public static implicit operator string(VP_SceneReference sceneReference)
        {
    ...
    /// </summary>
    [CustomPropertyDrawer(typeof(VP_SceneReference))]
