namespace VirtualPhenix.Dialog
{
    ...
    public class VP_DialogShakeAnimation : VP_DialogTextAnimation
    {
        ...
        public void LoadPreset(VP_DialogShakeLibrary library, string presetKey)
        {
