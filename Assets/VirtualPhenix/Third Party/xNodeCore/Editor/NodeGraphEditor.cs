...
namespace XNodeEditor {
    ...
    public class NodeGraphEditor : XNodeEditor.Internal.NodeEditorBase<NodeGraphEditor, NodeGraphEditor.CustomNodeGraphEditorAttribute, XNode.NodeGraph> {
        ...
        public virtual string GetPreferencesName()
        {
            return "Node Editor";
        }
        ...
        public virtual string GetNodeMenuName(Type type) {
            ...
            if (NodeEditorUtilities.GetAttrib(type, out attrib)) // Return custom path
                ...
                return ObjectNames.NicifyVariableName(typeStr);
        }
        ...
        public virtual void AddContextMenuItems(GenericMenu menu) {
            ...
            for (int i = 0; i < NodeEditorWindow.nodeTypes.Length; i++) {
               ...
               menu.AddItem(new GUIContent(path), false, () => {
                   //
                   if (NodeEditorWindow.current.IsDraggingOutputTest)
                   {
                       XNode.NodePort port = NodeEditorWindow.current.draggedOutputTest;
                       XNode.Node node = CreateNodeAndReturn(type, pos);
        ...
        public virtual Color GetPortColor(XNode.NodePort port) {
            return NodeEditorPreferences.GetNodePortColor();
        }
        ...
        /// <summary> Deal with objects dropped into the graph through DragAndDrop </summary>
        public virtual void OnDropObjects(UnityEngine.Object[] objects, XNode.Node hoveredNode )
        {
            Debug.Log("No OnDropItems override defined for " + GetType());
        }

        /// <summary> Create a node and save it in the graph asset </summary>
        public virtual XNode.Node CreateNodeAndReturn(Type type, Vector2 position)
        {
