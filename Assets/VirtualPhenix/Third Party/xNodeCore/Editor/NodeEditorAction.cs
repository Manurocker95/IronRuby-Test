...
namespace XNodeEditor {
    public partial class NodeEditorWindow {
       ...
       public bool IsDraggingOutputTest
        {
            get
            {
                return draggedOutputTest != null;
            }
        }

        [NonSerialized] public XNode.NodePort draggedOutputTest = null;
            ...
            switch (e.type) {
                ...
                case EventType.DragPerform:
                    ...
                    if (e.type == EventType.DragPerform) {
                        ...
                        if (IsHoveringNode)
                        {
                            graphEditor.OnDropObjects(DragAndDrop.objectReferences, hoveredNode);
                        }
                        else
                        {
                ...
                case EventType.MouseDrag:
                    if (e.button == 0)
                    {
                        if (IsDraggingPort)
                        {
                            ...
                            {
                                draggedOutputTest = draggedOutput;
                ...
                case EventType.MouseUp:
                    if (e.button == 0) {
                        ...
                        if (IsDraggingPort) {
                            ...
                            {
                                //TODO
                                if (!IsHoveringPort && !IsHoveringNode)
                                {
        ...
        public void DrawDraggedConnection() {
            if (IsDraggingPort) {
                Color col = NodeEditorPreferences.GetNodePortColor();
